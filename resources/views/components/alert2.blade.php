<div>
	<div class="fixed top-0 left-0 w-full p-2 z-40">
		<div x-bind:class="`relative bg-${ alertColor }-100 border-l-4 border-${ alertColor }-500 rounded-r text-${ alertColor }-900 mb-4 px-4 py-3 shadow-xl transform max-w-xl m-auto`" role="alert"
			x-show="alertShow"
